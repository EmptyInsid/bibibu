...
func (s Storage) Save(page *storage.Page) (err error) {
	...
	//создаём все нужные директории в этом пути
	if err := os.MkdirAll(filePath, defaltPerm); err != nil {
		return err
	}
	...
	//записываем страницу в нужном формате
